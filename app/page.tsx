...
const HOW_STEPS = [
  ...
  { emoji: '💰', title: 'Receba via Pix', desc: 'Controle seus ganhos e histórico de pagamentos no app.' },
];
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Acompanhe seus ganhos, pagamentos pendentes e histórico completo de recebimentos.',
    ...
    <main>
      ...
      <section id="como-funciona" className="lp-how">
        ...
        <div style={{ textAlign: 'center', marginTop: '40px' }}>
          <a href="https://zupet.io/download" target="_blank" rel="noopener noreferrer" className="parallax-btn-p" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true"><path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.7 9.05 7.4c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.39-1.32 2.76-2.53 3.99zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/></svg>
            App Store
          </a>
          {' '}
          <a href="https://zupet.io/download" target="_blank" rel="noopener noreferrer" className="parallax-btn-o" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginLeft: '10px' }}>
      ...
      <div id="planos" className="lp-plans">
        <div>
          ...
          <p className="lp-plans-sub">
            Sem cartão de crédito. Assine o Pro via Pix quando estiver pronto para escalar.
          </p>
        ...
        <div className="lp-plan-rows">
          ...
          <div className="lp-plan-row highlight">
            ...
            <Link href="/login" className="lp-plan-cta pro-btn">Assinar</Link>
          </div>
        </div>
      </div>
